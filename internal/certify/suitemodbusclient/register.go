...
func Register(reg *certify.Registry) {
	...
	reg.Register(rd2, Suite, checkREAD2, append(wire, certify.WithOrder(10))...)
	...
	reg.Register(cli4, Suite, checkCLI4, append(wire, certify.WithOrder(23))...)
	...
	reg.Register(er2, Suite, checkERR2, append(wire, certify.WithOrder(41))...)
	reg.Register(in2, Suite, checkINFO2, append(wire, certify.WithOrder(42))...)
	reg.Register(pr1, Suite, checkPROT1, append(wire, certify.WithOrder(43))...)

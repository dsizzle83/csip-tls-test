...
// OpenADR 3.1 VEN service (cmd/openadr + internal/openadr, pure Go: it speaks
// HTTPS to the VTN over stdlib crypto/tls and links no C TLS library at all,
// unlike the CSIP/mbaps paths that ride lexa-platform/mbedtls) — polls its
// configured VTN, translates Continuous-Pricing-profile

...
| P1 Shared modules (R2) | 019–024, 082 | IN PROGRESS (2026-07-05) | 021 lockstep: FAST 34P/17D/0F/0B; conformance 50/50; CSIP layers 1-3 3/3 | 019, 020, 021, 022, 023 DONE (details in task headers + `docs/refactor/notes/` disposition docs). One shared codec proven on hardware; bench sunspec fork deleted; lockstep gate green with empty allowlist; AD-003(e) interim vendoring keeps hosted CI green until TASK-024 hosting. Remaining: 024 (pin gate), 082 (bench derbase/device fork disposal + csip discovery/scheduler fork AD). |
